...
# arguments : [DCTCP or TCP] dctcp.out or tcp.out  numberflows=2 link_cap 100Mbps linkDelay 0.25ms DCTCP_K 20
# if {$argc != 6} {
...
set out_q_file DCTCP_q_size.out
set num_flows 2
...
set tcl_dir /Users/oljideje/workspace/repos/ns-install-osx/dctcp-example/dctcp2
