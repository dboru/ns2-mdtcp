...
##In case TCP , BW_bottlneckxRTT_network
...
for {set i 0} {$i < [expr $NSwitches - 2]} {incr i} {
    ...
    $ns duplex-link $sw($i) $sw([expr $i+2]) $link_bneck $link_delay $queue_type
