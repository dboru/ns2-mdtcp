...
plot "smptcp/flow1.tr" using 1:2 ls 1 title "TCP1" with lines,"smptcp/flow2.tr" using 1:2 ls 2 title "TCP2" with lines

#plot "smptcp/flow1.tr" using 1:2 ls 1 title "MPTCP-SF1" with lines,"smptcp/flow2.tr" using 1:2 ls 2 title #"MPTCP-SF2" with lines, "smptcp/tcp1.tr" using 1:2 ls 3 title "TCP1" with lines,"smptcp/tcp2.tr" using 1:2 ls 4 #title "TCP2" with lines
