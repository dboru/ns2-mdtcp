...
figdir='/Users/oljideje/workspace/repos/Scalable-multipath/figsnew'
set output figdir.'/MP'.mp.'_'.ctcp.'_cwnd_1bneck_'.qtype.'.eps'
...
set output figdir.'/MP'.mp.'_'.ctcp.'_tp_1bneck_'.qtype.'.eps'
