...
set output 'smptcp/tmpdctcp_cwnd.eps'
...
plot "smptcp/cwnd1.tr" using 1:2 ls 1 title "MPDCTCP-SF1" with lines,"smptcp/cwnd2.tr" using 1:2 ls 2 title "MPDCTCP-SF2" with lines
